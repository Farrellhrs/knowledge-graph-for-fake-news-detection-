#!/usr/bin/env python3
"""
Custom KAPALM (Knowledge grAPh# Configuration for Binary Classification - PolitiFact Dataset
CONFIG = {
    ...
    'seed': 42,
    'cache_dir': './cache_binary_politifact',
    'save_path': './kapalm_binary_politifact.pt',
    'log_file': './training_log_binary_politifact.csv'
...
# Configuration for Binary Classification - Indo-Malay Dataset
CONFIG = {
    'model_name': 'indolem/indobert-base-uncased',  # IndoBERT for Indonesian/Malay text
    'max_seq_length': 512,
    'batch_size': 32,
    'learning_rate': 1e-5,  
    'num_epochs': 100,  # Reduced epochs for binary classification
    'warmup_steps': 500,
    'max_grad_norm': 1.0,
    'centrality_top_n': 20,
    'hidden_dim': 768,
