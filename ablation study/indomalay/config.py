#!/usr/bin/env python3
"""
Configuration for KAPALM Ablation Study - Indo-Malay Dataset
"""
...
# Paths Configuration
PATHS = {
    'dataset': r'D:\farrell2\Fake News Politifact\dataset\dataset_sunda_malay__filtered_46k_no_dup.csv',
    'graphs_dir': r'D:\farrell2\Fake News Politifact\processed_graphs_indo_malay\successful',
    'cache_dir': r'D:\farrell2\Fake News Politifact\ablation_study\indomalay\cache',
    'results_dir': r'D:\farrell2\Fake News Politifact\ablation_study\indomalay\results',
    'checkpoints_dir': r'D:\farrell2\Fake News Politifact\ablation_study\indomalay\checkpoints',
}
...
def print_ablation_summary():
    ...
    print("=" * 80)
    print("\nNotation:")
    print("  h = text embedding (from IndoBERT)")
