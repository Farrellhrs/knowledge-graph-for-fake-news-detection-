#!/usr/bin/env python3
"""
Configuration for KAPALM Ablation Study - PolitiFact Dataset
"""
...
# Model Configuration
MODEL_CONFIG = {
    'model_name': 'bert-base-uncased',  # BERT for English PolitiFact text
    'max_seq_length': 512,
    'batch_size': 32,
    'learning_rate': 1e-5,
    'num_epochs': 100,
...
# Paths Configuration
PATHS = {
    'dataset': r'D:\farrell2\Fake News Politifact\dataset\politifact_01.csv',
    'graphs_dir': r'D:\farrell2\Fake News Politifact\processed_graphs_politifact\successful',
    'cache_dir': r'D:\farrell2\Fake News Politifact\ablation_study\politifact\cache',
    'results_dir': r'D:\farrell2\Fake News Politifact\ablation_study\politifact\results',
    'checkpoints_dir': r'D:\farrell2\Fake News Politifact\ablation_study\politifact\checkpoints',
}
